...
// Tambahkan audio
var audio = new Audio("istanapermen.mp3");
...
class game {
    ...
    init() {
        ...
        // Tambahkan event listener untuk memulai audio saat ada interaksi
        document.addEventListener('mousedown', () => this.startAudio());
        document.addEventListener('touchstart', () => this.startAudio());
        ...
        for (let i = 0; i < Nsnake; i++)
            ...
            mySnake[0] = new snake("Samsan", this, minScore, game_W / 2, game_H / 2);
    ...
    startAudio() {
        // Hanya memulai audio jika belum diputar
        if (audio.paused) {
            audio.loop = true; // Agar musik berulang
